...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/pi/catkin_ws/src/ros_comm/rostest)
  set(rostest_DEVEL_PREFIX /home/pi/catkin_ws/devel_isolated/rostest)
...
if(NOT "/home/pi/catkin_ws/src/ros_comm/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/ros_comm/rostest/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/ros_comm/rostest/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel_isolated/rostest/lib;/opt/ros/kinetic/lib)
