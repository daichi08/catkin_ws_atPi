...
if("TRUE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /home/pi/catkin_ws/src/ros_comm/rosgraph)
  set(rosgraph_DEVEL_PREFIX /home/pi/catkin_ws/devel_isolated/rosgraph)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/ros_comm/rosgraph/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel_isolated/rosgraph/lib;/opt/ros/kinetic/lib)
