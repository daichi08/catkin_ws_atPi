...
if("TRUE" STREQUAL "TRUE")
  set(rosboost_cfg_SOURCE_PREFIX /home/pi/catkin_ws/src/ros/rosboost_cfg)
  set(rosboost_cfg_DEVEL_PREFIX /home/pi/catkin_ws/devel_isolated/rosboost_cfg)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosboost_cfg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/ros/rosboost_cfg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel_isolated/rosboost_cfg/lib;/opt/ros/kinetic/lib)
