...
if("TRUE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /home/pi/catkin_ws/src/ros/rosbash)
  set(rosbash_DEVEL_PREFIX /home/pi/catkin_ws/devel_isolated/rosbash)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/ros/rosbash/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel_isolated/rosbash/lib;/opt/ros/kinetic/lib)
